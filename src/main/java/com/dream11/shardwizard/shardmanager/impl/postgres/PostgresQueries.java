...
public class PostgresQueries {
  ...
  public static String CREATE_SHARD_QUERY =
      "INSERT INTO ShardMaster (isdefault, details) VALUES ($1, $2) RETURNING shardid;";

  public static String DEACTIVATE_SHARD_QUERY =
      "UPDATE ShardMaster "
          + "SET isactive = false "
          + "WHERE shardid = $1 "
          + "  AND NOT EXISTS ( "
  ...
  public static String SET_DEFAULT_FLAG_QUERY_PREFIX =
      "UPDATE ShardMaster SET isdefault = $1 WHERE shardid IN (";

  public static String GET_DEFAULT_SHARDS_QUERY =
      "SELECT * FROM ShardMaster WHERE isdefault = true and isactive = true;";

  public static String CREATE_ENTITY_SHARD_MAPPING_QUERY =
  ...
  public static String DELETE_ENTITY_SHARD_MAPPING_QUERY =
